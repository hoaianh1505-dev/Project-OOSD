        ...
        <ul class="sidebar navbar-nav">
            ...
            <li class="nav-item dropdown <?= $c == "order" ? "active" : "" ?>">
                ...
                <div class="dropdown-menu <?= $c == "order" ? "show" : "" ?>" aria-labelledby="">
                    <a class="dropdown-item <?= $c == "order" && $a == "list" ? "active" : "" ?>"
                        href="index.php?c=order">Danh
                        sách</a>
                    <a class="dropdown-item <?= $c == "order" && $a == "add" ? "active" : "" ?>"
                        href="index.php?c=order&a=add">Thêm</a>
                </div>
            </li>
            <li class="nav-item dropdown <?= $c == "product" ? "active" : "" ?>">
                ...
                <div class="dropdown-menu <?= $c == "product" ? "show" : "" ?>" aria-labelledby="">
                    <a class="dropdown-item <?= $c == "product" && $a == "list" ? "active" : "" ?>"
                        href="index.php?c=product">Danh sách</a>
                    <a class="dropdown-item <?= $c == "product" && $a == "add" ? "active" : "" ?>"
                        href="index.php?c=product&a=add">Thêm</a>
                </div>
            </li>
            <li class="nav-item dropdown <?= $c == "comment" ? "active" : "" ?>">
                ...
                <div class="dropdown-menu <?= $c == "comment" ? "show" : "" ?>" aria-labelledby="">
                    <a class="dropdown-item <?= $c == "comment" ? "active" : "" ?>" href="index.php?c=comment">Danh
                        sách</a>
                </div>
            </li>
            ...
            <li class="nav-item dropdown <?= $c == "imageItem" ? "active" : "" ?>">
                ...
                <div class="dropdown-menu <?= $c == "imageItem" ? "show" : "" ?>" aria-labelledby="">
                    <a class="dropdown-item <?= $c == "imageItem" ? "active" : "" ?>" href="index.php?c=imageItem">Danh
                        sách</a>
                </div>
            </li>
            <li class="nav-item dropdown <?= $c == "customer" ? "active" : "" ?>">
                ...
                <div class="dropdown-menu <?= $c == "customer" ? "show" : "" ?>" aria-labelledby="">
                    <a class="dropdown-item <?= $c == "customer" && $a == "list"  ? "active" : "" ?> "
                        href="index.php?c=customer">Danh sách</a>
                    <a class="dropdown-item <?= $c == "customer" && $a == "add" ? "active" : "" ?>"
                        href="index.php?c=customer&a=add">Thêm</a>
                </div>
            </li>
            <li class="nav-item dropdown <?= $c == "category" ? "active" : "" ?>">
                ...
                <div class="dropdown-menu <?= $c == "category" ? "show" : "" ?>" aria-labelledby="">
                    <a class="dropdown-item <?= $c == "category" && $a == "list"  ? "active" : "" ?> "
                        href="index.php?c=category">Danh sách</a>
                    <a class="dropdown-item <?= $c == "category" && $a == "add" ? "active" : "" ?>"
                        href="index.php?c=category&a=add">Thêm</a>
                </div>
            </li>
            <li class="nav-item dropdown <?= $c == "brand" ? "active" : "" ?>">
                ...
                <div class="dropdown-menu <?= $c == "brand" ? "show" : "" ?>" aria-labelledby="">
                    <a class="dropdown-item <?= $c == "brand" && $a == "list"  ? "active" : "" ?> "
                        href="index.php?c=brand">Danh sách</a>
                    <a class="dropdown-item <?= $c == "brand" && $a == "add" ? "active" : "" ?>"
                        href="index.php?c=brand&a=add">Thêm</a>
                </div>
            </li>
            <li class="nav-item <?= $c == "shippingfee" ? "active" : "" ?>">
                <a class="nav-link" href="index.php?c=shippingfee"><i class="fas fa-shipping-fast"></i> <span>Phí giao
                        hàng</span></a>
            </li>
            ...
            <li class="nav-item dropdown <?= $c == "staff" ? "active" : "" ?>">
                ...
                <div class="dropdown-menu <?= $c == "staff" ? "show" : "" ?>" aria-labelledby="">
                    <a class="dropdown-item <?= $c == "staff" && $a == "list"  ? "active" : "" ?> "
                        href="index.php?c=staff">Danh sách</a>
                    <a class="dropdown-item <?= $c == "staff" && $a == "add" ? "active" : "" ?>"
                        href="index.php?c=staff&a=add">Thêm</a>
                </div>
            </li>
            ...
            <li class="nav-item dropdown <?= $c == "permission" ? "active" : "" ?>">
                ...
                <div class="dropdown-menu <?= $c == "permission" ? "show" : "" ?>" aria-labelledby="">
                    <a class="dropdown-item <?= $c == "permission" && $a == "listRole"  ? "active" : "" ?> "
                        href="index.php?c=permission&a=listRole">Danh sách vai trò</a>
                    <a class="dropdown-item <?= $c == "permission" && $a == "addRole" ? "active" : "" ?>"
                        href="index.php?c=permission&a=addRole">Thêm vai trò</a>
                    <a class="dropdown-item <?= $c == "permission" && $a == "listAction"  ? "active" : "" ?> "
                        href="index.php?c=permission&a=listAction">Danh sách tác vụ</a>
                </div>
            </li>


            <li class="nav-item <?= $c == "status" ? "active" : "" ?>">
                <a class="nav-link" href="index.php?c=status"><i class="fas fa-star-half-alt"></i> <span>Trạng thái đơn
                        hàng</span></a>
            </li>
            ...
            <li class="nav-item dropdown <?= $c == "newsletter" ? "active" : "" ?>">
                ...
                <div class="dropdown-menu <?= $c == "newsletter" ? "show" : "" ?>" aria-labelledby="">
                    <a class="dropdown-item <?= $c == "newsletter" && $a == "list"  ? "active" : "" ?> "
                        href="index.php?c=newsletter">Danh sách</a>
                    <a class="dropdown-item <?= $c == "newsletter" && $a == "sendEmail" ? "active" : "" ?>"
                        href="index.php?c=newsletter&a=sendEmail">Gởi mail</a>
                </div>
            </li>


        </ul>
        <div class="message bg-info text-center"
